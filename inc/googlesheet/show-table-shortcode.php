...
function get_google_sheet($atts = null)
{
    ...
    $start = '<style>th.my-table { color: ' . $atts['table_color_value'] . ' !important;white-space: pre-wrap !important;vertical-align: middle;line-height: 0.7rem !important;}
    th.my-table-th { padding: 0 !important;white-space: pre-wrap !important;text-align: center !important;vertical-align: middle !important;}</style>' .
    ...
    for ($i = 0; $i < 16; $i++) {
        if (isset($array[0][$i])) {
            $start .= '<th class="my-table my-table-th">' . $array[0][$i] . '</th>';
        }
    }
    $start .= '</tr></thead>';
